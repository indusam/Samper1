...
import { registerPatch } from 'web.utils';

// Define the custom patch
const CustomKanbanRecord = {
    events: {
...
// Register the patch to the KanbanRecord class
registerPatch('web.KanbanRecord', CustomKanbanRecord);
