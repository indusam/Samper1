        ...
        if not self.ing_limitante:
            for ingrediente in ingredientes:
                vals.append({
                    ...
                    'grasa_trans_kg':ingrediente.product_id.x_mgkg_grasas_trans * (self.cantidad * (ingrediente.x_porcentaje / 100)),
                    ...
                    'sodio_mg': ingrediente.product_id.x_mg_sodio / 100 * (self.cantidad * (ingrediente.x_porcentaje / 100))
        ...
        if self.ing_limitante:
            ...
            for ingrediente in ingredientes:
                vals.append({
                    ...
                    'grasa_trans_kg': ingrediente.product_id.x_mgkg_grasas_trans * self.cant_limitante * (ingrediente.product_qty / ncantidad_il),
                    ...
                    'sodio_mg': ingrediente.product_id.x_mg_sodio / 100 * self.cant_limitante * (ingrediente.product_qty / ncantidad_il)
                })
