...
class Formulas(models.TransientModel):
    ...
    def imprime_formula(self):
        ...
        if self.consolidado:
                ...
                if ingrediente.product_tmpl_id.route_ids.id == 5:
                    ...
                    for componente in subformula:
                        ...
                        if not ncomponente:
                            ...
                            #                 str(componente.x_porcentaje/100)+'\n'+
                            #     str(ncant_limitante * (componente.x_porcentaje / 100)))
            ...
            bom_ordenada = sorted(bom_consolidada, key=lambda l: (l.cant_tot, l.ingr.default_code), reverse=True)
