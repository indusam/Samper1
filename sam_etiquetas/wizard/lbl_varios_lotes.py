...
class LblVariosLotes(models.TransientModel):
    ...
    especie = fields.Selection(string="Especie", selection=[('a', 'Ave'), ('r', 'Res'),('c', 'Cerdo') ], required=True, )
    ...
    def onchange_lote1(self):
        if self.especie.product_id.x_cod_especie != self.lote1.product_id.x_cod_especie:
